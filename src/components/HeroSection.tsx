                                ...
                                >
                                    {[...Array(2)].map((_, i) => (
                                        [
                                            ...
                                            <span
                                                key={`fz-${i}-${name}`}
                                                className="fz-pill group flex-shrink-0 px-4 py-2 rounded-full bg-white/[0.03] whitespace-nowrap backdrop-blur-sm hover:bg-brand-copper/[0.08] transition-all duration-400 cursor-default"
                                            >
