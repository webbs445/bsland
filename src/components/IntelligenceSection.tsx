...
const freeZones = [
    { id: "shams", name: "SHAMS", license: 6885, renewal: 6885, visaCost: 6000, maxVisas: 3, color: "#D97706" },
    { id: "ifza", name: "IFZA", license: 12900, renewal: 12900, visaCost: 3000, maxVisas: 6, color: "#2563EB" },
    { id: "meydan", name: "Meydan Free Zone", license: 12520, renewal: 12780, visaCost: 7480, maxVisas: 6, color: "#0F766E" },
    { id: "rakez", name: "RAKEZ", license: 6010, renewal: 6010, visaCost: 4300, maxVisas: 6, color: "#B45309" },
    { id: "ajman", name: "Ajman Free Zone", license: 4888, renewal: 4888, visaCost: 4500, maxVisas: 6, color: "#7C3AED" },
    { id: "spc", name: "SPC Free Zone", license: 6885, renewal: 6885, visaCost: 7155, maxVisas: 6, color: "#0369A1" },
    { id: "dwc", name: "DWC (Dubai South)", license: 12540, renewal: 12540, visaCost: 7580, maxVisas: 6, color: "#374151" },
    { id: "dubai_silicon", name: "Dubai Silicon Oasis", license: 10000, renewal: 10000, visaCost: 3700, maxVisas: 6, color: "#DC2626" },
...
const GOV_FEES = { mainland: 5000, freezone: 1400, offshore: 800 };
                                        ...
                                        <div className="space-y-4 mb-8">
                                            ...
                                            <div className="flex justify-between items-center">
                                                ...
                                                <span className="text-sm font-bold text-white">
                                                    {calc[calcView].gov === 0 ? 'Free' : `AED ${calc[calcView].gov.toLocaleString()}`}
                                                </span>
                                            </div>
                                        </div>
